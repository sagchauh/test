...
const Updateadmindata = () => {
    ...
    useEffect(() => {
        async function showdata() {
            const response = await axios.post("http://15.207.248.127:8000/showsingleadmindata", {
                _id: id
            })
    ...
    const updateadminclick = async (e) => {
        ...
        const response = await axios.post("http://15.207.248.127:8000/updateadmindata", formData)
