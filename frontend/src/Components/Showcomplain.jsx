...
const Showcomplain = () => {
    ...
    useEffect(() => {
        async function complain() {
            const response = await axios.post("http://15.207.248.127:8000/showcomplain");
    ...
    const deletecomplain = async (e) => {
        ...
        const response = await axios.post("http://15.207.248.127:8000/deletecomplain", {
            _id: firstComplainId
        })
        console.log(response, "response")
        if (response.data.status === 200) {
            alert(response.data.message)
            const refreshresponse = await axios.post("http://15.207.248.127:8000/showcomplain");
