...
const Editemployeeattendance = () => {
    ...
    useEffect(() => {
        async function showdata() {
            const response = await axios.post("http://15.207.248.127:8000/showsingleemployee", { _id: id });
    ...
    const handleIntimeSubmit = async (e) => {
        ...
        if (selectedIntimeDate && day && time) {
            const response = await axios.post("http://15.207.248.127:8000/editintime", {
                _id: id,
    ...
    const handleOuttimeSubmit = async (e) => {
        ...
        if (selectedOuttimeDate && outday && outTime) {
            const response = await axios.post("http://15.207.248.127:8000/editouttime", {
                _id: id,
