...
//             const response = await axios.post("http://localhost:8000/singlestudentdata", {
//                 _id: id
//             })
...
//                 const response = await axios.post("http://localhost:8000/getrespectiveteachernames", {
...
//         const response = await axios.post("http://localhost:8000/updatestudentdata", formData)
...
const Updatestudentdata = () => {
    ...
    useEffect(() => {
        async function update() {
            const response = await axios.post("http://localhost:8000/singlestudentdata", { _id: id });
            setupdatedata(response.data);
    ...
    useEffect(() => {
        async function fetchTeacherNames() {
            if (selectcourse) {
                const response = await axios.post("http://localhost:8000/fetchteachname", {
                    courseId: selectcourse,
                });
